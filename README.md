...
- LENCO_WIDGET_URL / VITE_LENCO_WIDGET_URL - Inline widget script URL (defaults to `/payment.js` in production; sandbox/development still use Lenco’s sandbox URL unless you override).
